  ...
  return (
    ...
    <section>
        ...
        <section>
            ...
            <label key={index} className="block mb-2" htmlFor="">
        ...
        <div className="mb-5 mt-4">
            ...
            <div>
                {keywords.map((keyword,index)=> (
                    <button type="button" key={index} className="block mb-2 px-4 py-2 w-full text-left border rounded hover:bg-gray-200">
                        {keyword.toUpperCase()}
                    </button>
                ))}
            </div>
        </div>
                <button type="button" className="w-full mb-[4rem] py-2 bg-black text-white rounded mt-5">Reset Filters</button>
        </section>
    </div>
  )
}
